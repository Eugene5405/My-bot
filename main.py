...
# ===== КРАСИВЫЕ ПРИВЕТСТВИЯ ДЛЯ ВСЕХ ЯЗЫКОВ =====
...
🌤 WEATHER:
- /current — now: temp, feels, humidity
- /today — detailed for today
- /tomorrow — tomorrow forecast
- /week — 7 days ahead
- /hourly — hourly for 24h
...
- /mylocation — where I am now

Press Share Location to start, or choose button below.
Data: Open-Meteo • Working 24/7"""
...
📍 ЩО ВМІЮ:
🌤 ПОГОДА: /current /today /tomorrow /week /hourly
🔍 ДЕТАЛІ: /rain /wind /sun /uv /air /alerts
⏰ ЧАС: /time /dst
📍 ЛОКАЦІЯ: /location /mylocation
Натисни Share Location щоб почати."""

WELCOME_BE="""👋 Прывітанне! Я твой персанальны метэаролаг
📍 ШТО ЎМЕЮ:
🌤 НАДВОР'Е: /current /today /tomorrow /week /hourly
🔍 ДЭТАЛІ: /rain /wind /sun /uv /air /alerts
⏰ ЧАС: /time /dst
📍 ЛАКАЦЫЯ: /location /mylocation"""
...
📍 CO POTRAFIĘ:
🌤 POGODA: /current /today /tomorrow /week /hourly
🔍 SZCZEGÓŁY: /rain /wind /sun /uv /air /alerts
⏰ CZAS: /time /dst
📍 LOKALIZACJA: /location /mylocation"""
...
📍 WAS ICH KANN:
🌤 WETTER: /current /today /tomorrow /week /hourly
🔍 DETAILS: /rain /wind /sun /uv /air /alerts
⏰ ZEIT: /time /dst
📍 STANDORT: /location /mylocation"""

WELCOME_FR="""👋 Salut! Je suis ton météorologue personnel
Plus précis qu'iPhone, je n'oublie jamais le changement d'heure.
📍 CE QUE JE FAIS:
🌤 MÉTÉO: /current /today /tomorrow /week /hourly
🔍 DÉTAILS: /rain /wind /sun /uv /air /alerts
⏰ HEURE: /time /dst
📍 LIEU: /location /mylocation"""

WELCOME_ES="""👋 Hola! Soy tu meteorólogo personal
Más preciso que iPhone, nunca olvido el cambio de hora.
📍 QUÉ HAGO:
🌤 CLIMA: /current /today /tomorrow /week /hourly
🔍 DETALLES: /rain /wind /sun /uv /air /alerts
⏰ HORA: /time /dst
📍 UBICACIÓN: /location /mylocation"""

WELCOME_IT="""👋 Ciao! Sono il tuo meteorologo personale
Più preciso di iPhone, non dimentico mai l'ora legale.
📍 COSA SO FARE:
🌤 METEO: /current /today /tomorrow /week /hourly
🔍 DETTAGLI: /rain /wind /sun /uv /air /alerts
⏰ ORA: /time /dst
📍 POSIZIONE: /location /mylocation"""
