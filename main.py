...
"uk":{"name":"🇺🇦 Українська","welcome":"👋 *Привіт!*","weather_btn":"🌤 Команди погоди","time_btn":"⏰ Час і DST","loc_btn":"📍 Змінити локацію","help_btn":"⚙️ Допомога","back":"⬅️ Назад","choose_lang":"Обери мову:","lang_saved":"✅ Мова: Українська"},
